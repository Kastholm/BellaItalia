<template>
  <div class="bg-red-200 shadow-md rounded-lg overflow-hidden">
    ...
    >
    <h1 class="text-4xl text-center font-bold uppercase text-gray-800 font-header after mb-12">{{ menuPunkt.title }}</h1>
...
const query = groq`*[_type == "menu" && (title == "Forretter" || title == "Supper")] {
  title,
  sections [] {
    _key,
    _type,
