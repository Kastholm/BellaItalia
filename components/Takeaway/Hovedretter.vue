<template>
  ...
  <div v-else class="shadow-md rounded-lg overflow-hidden  ">
        ...
        Til alle vores kødretter og fiskeretter kan der frit vælges mellem bagt kartoffel, pommes frites, rosmarinkartofler
      </h3>
          ...
          <h3 class="text-2xl text-center mb-6  font-header ">Ekstra brød og smør 8 kr.</h3>
        </div>
  </div>
</template>
