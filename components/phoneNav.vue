<template>
  <header
    class="bg-[#fbfbfb] z-40 fixed w-screen top-0 block md:hidden"
  >
    ...
    >
      ...
      <DialogPanel
        class="fixed inset-y-0 right-0 bg-gray-100 z-10 flex w-full flex-col justify-between overflow-y-auto bg-Metric sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
      >
        <div class="p-6 ">
            ...
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6 ">
                <NuxtLink
                  ...
                  :to="item.href"
                  @click="mobileMenuOpen = false"
                  class="group shadow-md -mx-3 flex items-center gap-x-6 rounded-lg p-3 text-base font-semibold leading-7 text-smooth"
                >
                  <div
